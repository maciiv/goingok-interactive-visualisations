...
export class ExperimentalDashboard extends Dashboard {
    ...
    handleGroupsSort() {
        ...
        d3.select(`#${id} .btn-group-toggle`).on("click", (e) => {
    ...
    extendHistogram(dashboard) {
        ...
        function onClick(e, d) {
            ...
            console.log(chart.data.filter(c => c.value.map(r => d.bin.x0 === 0 ? r.point < d.bin.x1 : d.bin.x1 === 100 ? r.point > d.bin.x0 : r.point > d.bin.x0 && r.point < d.bin.x1)))
