...
import { AuthorControlInteractions } from "../charts/interactions.js";
...
export class AuthorControlCharts {
    ...
    renderNetwork(chart, data, reflection) {
        const _this = this;
    ...
    renderReflections(data) {
        ...
        d3.select("#reflections .reflections-tab")
            ...
            .html(d => _this.processReflectionsText(d))), update => update.attr("id", d => `ref-${d.refId}`)
            .select("p")
...
export function buildControlAuthorAnalyticsCharts(entriesRaw) {
    return __awaiter(this, void 0, void 0, function* () {
        const loading = new Loading();
        const colourScale = d3.scaleOrdinal(d3.schemeCategory10);
        const entries = d3.sort(entriesRaw.reflections.map(d => { return { "refId": d.refId, "timestamp": new Date(d.timestamp), "point": d.point, "text": d.text }; }), d => d.timestamp);
        ...
        yield drawCharts(authorAnalyticsData);
