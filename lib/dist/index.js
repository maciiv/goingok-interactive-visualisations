...
import { AdminAnalyticsData, AdminAnalyticsDataStats } from "./data/data.js";
...
class HistogramChartSeries extends ChartSeries {
...
class HistogramData extends AdminAnalyticsData {
...
class AdminControlTransitions extends Transitions {
...
class AdminControlInteractions extends AdminControlTransitions {
    constructor() {
        super(...arguments);
...
class AdminExperimentalCharts extends AdminControlCharts {
    constructor() {
        super(...arguments);
        this.sorted = "date";
...
class AdminExperimentalInteractions extends AdminControlInteractions {
    constructor() {
        super(...arguments);
...
class ClickAdmin extends Click {
...
class AuthorControlTransitions extends Transitions {
}
class AuthorControlInteractions extends AuthorControlTransitions {
    constructor() {
        super(...arguments);
        this.tooltip = new Tooltip();
        this.zoom = new Zoom();
...
class AuthorExperimentalCharts extends AuthorControlCharts {
    constructor() {
        super(...arguments);
...
class AuthorExperimentalInteractions extends AuthorControlInteractions {
    constructor() {
        super(...arguments);
