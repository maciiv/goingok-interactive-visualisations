...
var AdminExperimentalCharts = /** @class */ (function (_super) {
    ...
    AdminExperimentalCharts.prototype.renderGroupChart = function (chart, data) {
        ...
        _this.htmlContainers.boxPlot.select(".card-header button")
            .on("click", function (e) {
            var showHelp = _this.htmlContainers.helpPopover(d3.select(this), chart.id + "-help", "<b>Box plot</b><br>A box plot is used to show the data distribution<br><i>Q3:</i> The median of the upper half of the data set<br><i>Median:</i> The middle value of a dataset<br><i>Q1:</i> The median of the lower half of the dataset");
        ...
        function onClick(e, d) {
            ...
            _this.htmlContainers.histogram.select(".card-header button")
                ...
                var showDragHelp = _this.htmlContainers.helpPopover(_this.histogram.elements.contentContainer.select(".threshold-line.soaring"), _this.histogram.id + "-help-drag", "<u><i>drag</i></u> me to change the thresholds");
                if (showDragHelp) {
            ...
            _this.htmlContainers.userHistogram.select(".card-header button")
                ...
                var showDragHelp = _this.htmlContainers.helpPopover(_this.usersHistogram.elements.contentContainer.select(".threshold-line.soaring"), _this.usersHistogram.id + "-help-drag", "<u><i>drag</i></u> me to change the thresholds");
                if (showDragHelp) {
            ...
            _this.htmlContainers.timeline.select(".card-header button")
                ...
                if (!_this.timeline.elements.contentContainer.select("#" + _this.timeline.id + "-timeline-circles").empty()) {
                    var showDataHelp = _this.htmlContainers.helpPopover(_this.timeline.elements.contentContainer.select("#" + _this.timeline.id + "-timeline-circles"), _this.timeline.id + "-help-data", "<u><i>hover</i></u> me for information on demand<br><u><i>click</i></u> me to connect the user's reflections");
                    if (showDataHelp) {
...
function buildControlAdminAnalyticsCharts(entriesRaw) {
    ...
    function drawCharts(allEntries) {
        ...
        adminControlCharts.htmlContainers.histogram.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), histogramChart.id + "-help", "<b>Histogram</b><br>A histogram group data points into user-specific ranges. The data points in this histogram are <i>reflections</i>");
        ...
        adminControlCharts.htmlContainers.userHistogram.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), histogramUsersChart.id + "-help", "<b>Histogram</b><br>A histogram group data points into user-specific ranges. The data points in this histogram are <i>users average state</i>");
        ...
        adminControlCharts.htmlContainers.timeline.select(".card-header button")
            ...
            if (!timelineChart.elements.contentContainer.select("#" + timelineChart.id + "-timeline-circles").empty()) {
                var showDataHelp = adminControlCharts.htmlContainers.helpPopover(timelineChart.elements.contentContainer.select("#" + timelineChart.id + "-timeline-circles"), timelineChart.id + "-help-data", "<u><i>hover</i></u> me for information on demand");
                if (showDataHelp) {
