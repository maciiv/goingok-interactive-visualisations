...
var AuthorControlCharts = /** @class */ (function () {
    ...
    AuthorControlCharts.prototype.renderNetwork = function (chart, data) {
        function ticked(g) {
            g.selectAll(".network-link").transition()
                .duration(750)
            ...
            g.selectAll(".network-node").transition()
                .duration(750)
                .attr("x", function (d) { return d.x - ((g.selectAll("#text-" + d.index).node().getBoundingClientRect().width + 10) / 2); })
                .attr("y", function (d) { return d.y - (g.selectAll("#text-" + d.index).node().getBoundingClientRect().height / 2); })
                .attr("width", function (d) { return g.selectAll("#text-" + d.index).node().getBoundingClientRect().width + 10; })
                .attr("height", function (d) { return g.selectAll("#text-" + d.index).node().getBoundingClientRect().height + 5; });
        }
        function applyForce(d, g) {
            d3.forceSimulation(d.tags)
        ...
        chart.elements.contentContainer.selectAll(".network-group")
            ...
            .attr("transform", function (d) { return "translate(" + chart.x.scale(d.timestamp) + ", " + chart.y.scale(50) + ")"; })
            .call(function (enter) { return enter.selectAll(".network-link")
            .data(function (d) { return d.links; })
            .enter()
            .append("line")
            .attr("class", "network-link"); })
            .call(function (enter) { return enter.selectAll(".network-node")
            .data(function (d) { return d.tags; })
            .enter()
            .append("rect")
            .attr("class", function (d) { return "network-node " + d.tag.toLowerCase(); }); })
            .call(function (enter) { return enter.selectAll(".network-text")
            .data(function (d) { return d.tags; })
            .enter()
            .append("text")
        ...
        chart.elements.contentContainer.selectAll(".network-group")
            .each(function (d, i, g) { return applyForce(d, d3.select(g[i])); });
        return chart;
    };
    ...
    AuthorControlCharts.prototype.processReflectionsText = function (tags, words) {
        ...
        var _loop_1 = function () {
            ...
            var isOpenTag = tags.find(function (c) { return c.start_index === currentWord.start_index; });
            var isCloseTag = tags.find(function (c) { return c.end_index === currentWord.start_index; });
...
function buildControlAuthorAnalyticsCharts(entriesRaw) {
    return __awaiter(this, void 0, void 0, function () {
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                var authorControlCharts, summaryData, summaryChart, reflectionTimelineChart, networkChart;
                return __generator(this, function (_a) {
                    ...
                    networkChart = new ChartNetwork("timeline", "chart-container-network", entries.map(function (d) { return d.timestamp; }));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loading = new Loading();
                    entries = entriesRaw.map(function (d) { return { "timestamp": new Date(d.timestamp), "pseudonym": d.pseudonym, "point": d.point, "text": d.text, "tags": d.tags, "links": d.links, "words": d.words }; });
                    return [4 /*yield*/, drawCharts(entries)];
                case 1:
                    _a.sent();
                    loading.isLoading = false;
