...
function buildControlAdminAnalyticsCharts(entriesRaw) {
    ...
    function drawCharts(allEntries) {
        ...
        var boxplotCard = adminControlCharts.htmlContainers.appendCard(adminControlCharts.htmlContainers.boxPlot, "All groups' reflections box plot", undefined, true);
        ...
        var timelineCard = adminControlCharts.htmlContainers.appendCard(adminControlCharts.htmlContainers.timeline, "Reflections' group vs time", undefined, true);
        timelineCard.select(".card-body")
            .attr("class", "card-body")
            .append("ul")
