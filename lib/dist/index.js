...
var AdminControlCharts = /** @class */ (function () {
    ...
    AdminControlCharts.prototype.renderViolin = function (chart, data) {
        ...
        function onMouseover(e, d) {
            ...
            _this.interactions.tooltip.positionTooltipContainer(chart, bandwithScale(1), parseInt(d3.select(this).attr("y")) - d3.selectAll(".violin-text-box").node().getBBox().height);
        }
        function onMouseout() {
            chart.elements.svg.select(".tooltip-container").transition()
                .style("opacity", 0);
...
function buildControlAdminAnalyticsCharts(entries) {
    ...
    function drawCharts(allEntries) {
        ...
        var groupsStatisticsCard = adminControlCharts.htmlContainers.appendCard(adminControlCharts.htmlContainers.groupStatistics, "Statitics");
