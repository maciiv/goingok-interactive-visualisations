...
var AuthorControlCharts = /** @class */ (function () {
    ...
    AuthorControlCharts.prototype.renderTimeline = function (chart, data) {
        ...
        var softLine = d3.line()
            ...
            .y(function (d) { return chart.y.scale(d.point); })
            .curve(d3.curveBasis);
        var avg = d3.mean(data, function (d) { return chart.y.scale(d.point); });
        ...
        chart.elements.contentContainer.append("path")
            .datum(d3.sort(data, function (d) { return d.timestamp; }))
            .attr("class", "softline")
            .attr("d", function (d) { return softLine(d); });
        chart.elements.contentContainer.append("path")
            .datum(d3.sort(data, function (d) { return d.timestamp; }))
            .attr("class", "meanline")
            .attr("d", function (d) { return meanLine(d); });
        chart.elements.contentContainer.selectAll(".point")
            ...
            .duration(750)
            .attr("r", 5)
            .attr("cy", function (d) { return chart.y.scale(d.point); }); }); }, function (update) { return update.call(function (update) { return update.transition()
            .duration(750)
            .attr("cx", function (d) { return chart.x.scale(d.timestamp); })
            .attr("cy", function (d) { return chart.y.scale(d.point); }); }); }, function (exit) { return exit.remove(); });
...
function buildControlAuthorAnalyticsCharts(entriesRaw, analyticsRaw) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                var authorControlCharts, timelineChart, networkChart, networkData;
                return __generator(this, function (_a) {
