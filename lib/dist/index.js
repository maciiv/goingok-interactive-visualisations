...
var AdminControlCharts = /** @class */ (function () {
    ...
    AdminControlCharts.prototype.renderTimelineScatter = function (chart, zoomChart, data) {
        ...
        chart.elements.zoomSVG.selectAll(".zoom-timeline-container")
            ...
            .call(function (enter) { return _this.interactions.timelineScatter(enter, zoomChart, true); }); }, function (update) { return update.call(function (update) { return _this.interactions.timelineScatter(update, zoomChart, true); }); }, function (exit) { return exit.remove(); });
        ...
        function zoomed(e) {
            ...
            var newLine = d3.line()
                .x(function (d) { return chart.x.scale(d.timestamp); })
                .y(function (d) { return chart.y.scale(d.point); });
            chart.elements.contentContainer.selectAll(".line-circle")
    ...
    function drawCharts(allEntries) {
        ...
        adminExperimentalCharts.htmlContainers.timeline.select(".card-title button")
            ...
            if (!adminExperimentalCharts.timeline.elements.contentContainer.select(".line-circle").empty()) {
                ...
                var showDataHelp = adminExperimentalCharts.htmlContainers.helpPopover(adminExperimentalCharts.timeline.elements.contentContainer.select(".line-circle"), adminExperimentalCharts.timeline.id + "-help-data", "<u><i>hover</i></u> me for information on demand<br><u><i>click</i></u> me to connect the user's reflections");
                if (showDataHelp) {
