...
var AuthorControlCharts = /** @class */ (function () {
    ...
    AuthorControlCharts.prototype.renderSummary = function (chart, data) {
        chart.elements.contentContainer.selectAll(".summary-bar")
            ...
            .attr("x", function (d, i) { return chart.x.scale(i === 0 ? 0.1 : data[i - 1].percentage); })
        ...
        chart.elements.contentContainer.selectAll(".summary-percentage")
            ...
            .attr("x", function (d, i) { return chart.x.scale(i === 0 ? d.percentage / 2 : data[i - 1].percentage + (d.percentage / 2)); })
        ...
        chart.elements.svg.selectAll(".summary-tag")
            ...
            .attr("x", function (d, i) { return chart.x.scale(i === 0 ? d.percentage / 2 : data[i - 1].percentage + (d.percentage / 2)) + 5; })
            .attr("y", chart.y.scale(-0.5))
    ...
    AuthorControlCharts.prototype.renderReflections = function (data) {
        var _this = this;
        d3.select("#reflections .card-body")
...
function buildControlAuthorAnalyticsCharts(entriesRaw) {
    return __awaiter(this, void 0, void 0, function () {
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                var authorControlCharts, summaryData, summaryChart, networkChart;
                return __generator(this, function (_a) {
