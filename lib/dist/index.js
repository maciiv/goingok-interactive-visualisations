        ...
        d3.select("#group-timeline #timeline-plot").on("click", function (e) {
            ...
            if (!d3.select("#" + chart.id + "-help").empty()) {
                ...
                d3.select("#group-timeline #timeline-plot")
                    ...
                    console.log(d3.select("#" + chart.id + "-help-button"))
...
function buildControlAdminAnalyticsCharts(entriesRaw) {
    ...
    function drawCharts(allEntries) {
        ...
        adminControlCharts.htmlContainers.boxPlot.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), groupChart + "-help");
        ...
        adminControlCharts.htmlContainers.violin.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), violinChart + "-help");
        ...
        adminControlCharts.htmlContainers.userViolin.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), violinUsersChart + "-help");
        ...
        adminControlCharts.htmlContainers.timeline.select(".card-header button")
            .on("click", function (e) {
            var showHelp = adminControlCharts.htmlContainers.helpPopover(d3.select(this), timelineChart + "-help");
