...
var AdminControlCharts = /** @class */ (function () {
    ...
    ;
    AdminControlCharts.prototype.renderNavbarScrollspy = function () {
        d3.select("#analytics-navbar")
            .append("ul")
            .attr("class", "nav nav-pills")
            .html("<li class=\"nav-item\">\n                        <a class=\"nav-link\" href=\"#" + this.htmlContainers.boxPlot.attr("id") + "\">Box Plot</a>\n                    </li>\n                    <li class=\"nav-item\">\n                        <a class=\"nav-link\" href=\"#" + this.htmlContainers.violin.attr("id") + "\">Histograms</a>\n                    </li>\n                    <li class=\"nav-item\">\n                        <a class=\"nav-link\" href=\"#" + this.htmlContainers.timeline.attr("id") + "\">Timeline</a>\n                    </li>\n                    <li class=\"nav-item\">\n                        <a class=\"nav-link\" href=\"#" + this.htmlContainers.userStatistics.attr("id") + "\">Users</a>\n                    </li>");
    };
    ;
