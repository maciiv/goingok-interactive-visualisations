...
var ChartNetwork = /** @class */ (function () {
    ...
    ChartNetwork.prototype.resetTimeRange = function () {
...
function buildControlAuthorAnalyticsCharts(entriesRaw, analyticsRaw) {
    return __awaiter(this, void 0, void 0, function () {
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                var authorControlCharts, networkChart, networkData;
                return __generator(this, function (_a) {
                    authorControlCharts = new AuthorControlCharts();
                    networkChart = new ChartNetwork("timeline", "chart-container-timeline", entries.map(function (d) { return d.timestamp; }));
                    ...
                    d3.select("#timeline .card-title button")
                        ...
                        if (!networkChart.elements.contentContainer.select(".reflection-group").empty()) {
                            ...
                            var showDataHelp = authorControlCharts.help.helpPopover(networkChart.elements.contentContainer.select(".reflection-group"), networkChart.id + "-help-data", "<u><i>hover</i></u> me for information on demand");
                            if (showDataHelp) {
