...
var AdminControlCharts = /** @class */ (function () {
    ...
    AdminControlCharts.prototype.renderGroupChart = function (chart, data) {
        ...
        function onMouseover(e, d) {
            ...
            var tooltipBox = _this.interactions.tooltip.appendTooltipText(chart, d.group, d.stats.filter(function (c, i) { return i < 4; }).map(function (c) { return new TooltipValues(c.stat, c.value); }));
    ...
    AdminControlCharts.prototype.renderUserStatistics = function (card, data, pseudonym) {
        ...
        tabPane.select(".row").append("div")
            ...
            .enter()
            .append("p")
            .html(function (d) { return "<b>" + d.timestamp.toDateString() + " - Reflection Point: " + d.point + "</b><br>" + d.text; });
...
var AdminExperimentalCharts = /** @class */ (function (_super) {
    ...
    AdminExperimentalCharts.prototype.renderGroupChart = function (chart, data) {
        ...
        _this.htmlContainers.boxPlot.select(".card-title button")
            .on("click", function (e) {
            _this.htmlContainers.helpPopover(d3.select(this), chart.id + "-help", "<b>Box plot</b><br>A box plot is used to show the data distribution<br><i>Q3:</i> The median of the upper half of the data set<br><i>Median:</i> The middle value of a dataset<br><i>Q1:</i> The median of the lower half of the dataset");
        ...
        function onClick(e, d) {
            ...
            _this.htmlContainers.histogram.select(".card-title button")
                .on("click", function (e) {
            ...
            _this.htmlContainers.userHistogram.select(".card-title button")
                .on("click", function (e) {
            ...
            _this.renderTimelineButtons(timelineCard);
            _this.handleTimelineButtons(_this.timeline, _this.timelineZoom, d);
            _this.htmlContainers.timeline.select(".card-title button")
                .on("click", function (e) {
