...
var AuthorControlCharts = /** @class */ (function () {
    ...
    AuthorControlCharts.prototype.processNetworkData = function (chart, entries) {
        var networkData = { "tags": [], "links": [] };
        entries.forEach(function (c) {
            networkData.tags = networkData.tags.concat(c.tags);
            var refTag = { "tag": "ref", "phrase": c.timestamp.toDateString(), "fx": chart.x.scale(c.timestamp) };
    ...
    AuthorControlCharts.prototype.processSimulation = function (chart, data) {
        return d3.forceSimulation(data.tags)
    ...
    AuthorControlCharts.prototype.renderNetwork = function (chart, data) {
        var _this = this;
        if (data.tags.map(function (d) { return d.x; }).filter(function (d) { return d !== undefined; }).length === 0) {
        ...
        chart.elements.contentContainer.selectAll(".network-link")
            ...
            .attr("y2", function (d) { return d.target.y; }); }); }, function (update) { return update.call(function (update) { return update.transition()
            .duration(750)
            .attr("x1", function (d) { return d.source.x; })
            .attr("y1", function (d) { return d.source.y; })
            .attr("x2", function (d) { return d.target.x; })
        ...
        chart.elements.contentContainer.selectAll(".network-node-group")
            ...
            .duration(750)
            .attr("transform", function (d) { return "translate(" + d.x + ", " + d.y + ")"; }); }); }, function (exit) { return exit.remove(); });
    ...
    AuthorControlCharts.prototype.renderReflections = function (data) {
        ...
        d3.select("#reflections .reflections-tab")
            ...
            .call(function (div) { return div.append("p")
            .html(function (d) { return _this.processReflectionsText(d); }); });
    };
    ...
    return __awaiter(this, void 0, void 0, function () {
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    timelineChart = new ChartTime("timeline", entries.map(function (d) { return d.timestamp; }));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loading = new Loading();
                    entries = entriesRaw.map(function (d, i) { return { "timestamp": new Date(d.timestamp), "pseudonym": d.pseudonym, "point": d.point, "text": d.text, "tags": analyticsRaw[i].tags, "matrix": analyticsRaw[i].matrix }; });
                    return [4 /*yield*/, drawCharts(entries)];
                case 1:
                    _a.sent();
                    loading.isLoading = false;
