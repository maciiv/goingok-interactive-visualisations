...
var AuthorControlCharts = /** @class */ (function () {
        ...
        entries.forEach(function (c) {
            ...
            c.matrix.forEach(function (r, i) {
                for (var x = 0; x < r.length; x++) {
                    if (r[x] !== 0)
                        networkData.links.push({ "source": c.tags[i], "target": c.tags[x], "weight": r[x] });
                }
    ...
    AuthorControlCharts.prototype.processTimelineSimulation = function (centerX, centerY, nodes) {
        console.log(centerX, centerY, nodes)
    ...
    AuthorControlCharts.prototype.renderTimeline = function (chart, data) {
        ...
        chart.elements.contentContainer.selectAll(".circle-tag-container")
            ...
            .attr("cx", function (d) { console.log(enter.nodes()); return d.x; })
            ...
            .attr("cy", function (d) { return chart.y.scale(d.point); })
            .style("fill", "#f2f2f2")
            .style("stroke", "#f2f2f2"); }); }, function (exit) { return exit.remove(); });
        ...
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    timelineChart = new ChartTime("timeline", entries.map(function (d) { return d.timestamp; }), new ChartPadding(40, 75, 10, 10));
                    entries.forEach(function (c) { return authorControlCharts.processTimelineSimulation(timelineChart.x.scale(c.timestamp), timelineChart.y.scale(c.point), c.tags); });
        ...
        function drawCharts(entries) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    authorExperimentalCharts.timelineChart = new ChartTime("timeline", entries.map(function (d) { return d.timestamp; }), new ChartPadding(40, 75, 10, 10));
