    ...
    AdminControlCharts.prototype.renderViolin = function (chart, data) {
        ...
        binContainer.exit()
            ...
            d3.select(g[i])
                ...
                .transition()
                .duration(250)
                .attr("y", function (c) { return chart.y.scale(c.x0); })
                .attr("height", 0);
        })
            .transition()
            .duration(250)
...
var AdminControlTransitions = /** @class */ (function () {
    ...
    AdminControlTransitions.prototype.axisSeries = function (chart, data, delay) {
    ...
    ;
    AdminControlTransitions.prototype.violin = function (chart, delay) {
        //Draw violins
