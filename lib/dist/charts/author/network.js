...
export class Network extends ChartNetwork {
    ...
    render() {
        ...
        let edges = _this.elements.contentContainer.selectAll(".network-link")
            ...
            .attr("y2", _this.height / 2), update => update.call(update => update.classed("reflection-link", d => d.isReflection)
            .transition()
            .duration(750)
        ...
        let nodes = _this.elements.content = _this.elements.contentContainer.selectAll(".network-node-group")
            ...
            .attr("y", -5)
            .attr("width", 10)
            .attr("height", 10)), update => update.call(update => update.transition()
            .duration(750)
    ...
    processSimulation(data) {
        return d3.forceSimulation(data.analytics.nodes)
